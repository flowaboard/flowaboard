...
matheMaticsDesign.add(new DesignElement('Functions', 'functions', `https://en.wikipedia.org/wiki/Function_(mathematics)`,'flow-info','/elements/functions/index.js'))
matheMaticsDesign.add(new DesignElement('Equations', 'equations', `https://en.wikipedia.org/wiki/Equation`,'flow-info','/elements/equations/index.js'))
