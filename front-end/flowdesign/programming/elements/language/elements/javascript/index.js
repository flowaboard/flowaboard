...
javascriptElementsDesign.add(new JavascriptElement('Literal', 'jsliterals', `https://en.wikipedia.org/wiki/User_interface`,'element-info','/elements/literal/index.js'))
...
javascriptElementsDesign.add(new JavascriptElement('Control', 'loop', `https://en.wikipedia.org/wiki/Database`,'element-info','/elements/control/index.js'))
...
javascriptElementsDesign.add(new JavascriptElement('Object', 'object', `https://en.wikipedia.org/wiki/Desktop_application`,'element-info','/elements/object/index.js'))
