...
class Modal extends Element{
    ...
    static getSample(){
        const input=document.createElement('ui-modal')
    ...
    get CSS(){
        ...
        ::slotted(label),label{
            ...
            align-items: center;
            padding: var(--ui-modal-label-padding,0.2rem 2rem);
            flex:var(--ui-modal-leabel-flex,2);
        }
        ::slotted(input),input{
            flex:var(--ui-modal-input-flex,8);
            padding:var(--ui-modal-input-padding,0.2rem);
            width: 100%;
        }
        ::slotted(button),button{
            flex:var(--ui-modal-btton-flex,2);
            border: unset;
            padding: 0;
